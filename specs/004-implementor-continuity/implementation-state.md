...
| P-003 | protected-path-authorization | root docs (`README.md`, `setup.md`, `RepoStructure.md`, `docs/**`) | Document continuity semantics (T006) | Write access scoped to the four root documentation targets | n/a | `auth:004:root-docs` | already-authorized | resolved |
